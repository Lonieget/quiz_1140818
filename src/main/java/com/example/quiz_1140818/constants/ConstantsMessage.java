...
public class ConstantsMessage {
	 ...
	 *       ，用底線串接不同的字<br>
	 * static:將變數變成全域(只有一個記憶體位址)，可直接使用類別名稱來呼叫使用<br>
	 *         例如: ConstantsMessage.PARAM_ACCOUNT_ERROR
	 */
	public static final String PARAM_ACCOUNT_ERROR = "Param account error!!";

	public static final String PARAM_PASSWORD_ERROR = "Param account error!!";
	...
	public static final String QUESTION_OPTINOS_CODE_ERROR = "Question options code error!!";
	
	public static final String QUESTION_OPTINOS_NAME_ERROR = "Question options name error!!";
	...
	public static final String USER_EMALL_ERROR = "User emall error!!";
